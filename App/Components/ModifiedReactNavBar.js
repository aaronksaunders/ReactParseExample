...
var NavigationBar = React.createClass({
    ...
    doOnPressPrev: function () {
        (this.props.onPrev && this.props.onPrev() ) || this.props.navigator.pop();
        (this.props.navigator.onPrev ? this.props.navigator.onPrev() : true );
        console.log("doOnPressPrev");
    },
    ...
    getLeftButtonElement: function () {
        ...
        return (
            <TouchableOpacity onPress={ ()=> this.doOnPressPrev()}>
    ...
    doOnPressNext: function () {
        this.props.onNext && this.props.onNext();
        (this.props.navigator.onNext ? this.props.navigator.onNext() : true );
        console.log("doOnPressNext");
    },
    ...
    getRightButtonElement: function () {
        ...
        return (
            <TouchableOpacity onPress={ ()=> this.doOnPressNext()}>
